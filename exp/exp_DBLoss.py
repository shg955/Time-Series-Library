...
class Exp_DBLoss(Exp_Basic):
    def __init__(self, args):
        super(Exp_DBLoss, self).__init__(args)
    ...
    def _select_criterion(self):
        alpha = 0.1   # EMA 평활 계수 (논문 기준 0.x 대)
        beta = 0.1    # season vs trend 가중치

        criterion = DBLoss(alpha=alpha, beta=beta)
        return criterion
