...
for features, target in feature_settings:
    for pred_len in pred_lens:
        ...
        base_model_id = f"iTransformer_Traffic_96_{pred_len}_{suffix}"

        # features가 S일 때는 1, 아닐 때는 862
        enc_dec_c_out = "1" if features == "S" else "862"
